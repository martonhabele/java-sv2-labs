...
class TruckTest {
    ...
    void testGetShortestLength() {
        assertEquals(0.8d, truck.getShortestLength());
    }

    @Test
    void testGetShortestLengthForEmptyList() {
        truck = new Truck(new ArrayList<>());
        assertEquals(0d, truck.getShortestLength());
    }
    ...
    void testGetAverageWeightEmptyList() {
        truck = new Truck(new ArrayList<>());
        Exception ex = assertThrows(IllegalArgumentException.class, () -> truck.getAverageWeight());
