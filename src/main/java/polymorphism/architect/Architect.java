...
public class Architect {
    public static void main(String[] args) {
        ...
        PermitPlan permitPlan2 = new PermitPlan(50, "Wooden House", "John Doe",
                "Exeteer St. 1.");
        ...
        ConstructionPlan constructionPlan = new ConstructionPlan(50, "Wooden house", "John Doe",
                "Exeteer St. 1.", 25);
